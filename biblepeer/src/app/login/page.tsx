      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bp-card p-8">
          ...
          <p className="mb-6 text-center text-sm text-muted">
            Sign in to join your circles.
          </p>

          {error && (
            <p className="mb-4 rounded-lg border border-bp-red/40 bg-bp-red/10 px-3 py-2 text-sm font-semibold text-bp-red">
          ...
          {emailEnabled && (
            ...
            >
              <input
                ...
                className="w-full rounded-lg border border-border-dim bg-background px-3 py-2.5 text-sm outline-none placeholder:text-muted focus:border-gold"
              />
              <button
                type="submit"
                className="w-full rounded-lg border border-border-dim px-4 py-2.5 text-sm font-bold transition hover:border-gold hover:text-gold"
              >
          ...
          {!googleEnabled && !emailEnabled && (
            <p className="text-center text-sm font-semibold text-bp-red">
