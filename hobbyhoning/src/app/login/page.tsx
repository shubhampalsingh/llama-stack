    ...
    <main className="flex flex-1 items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        ...
        <div className="hh-card p-8">
          ...
          {error && (
            <p className="mb-4 rounded-lg border border-hh-red/40 bg-hh-red/10 px-3 py-2 text-sm font-semibold text-hh-red">
          ...
          {emailEnabled && (
            ...
            >
              <input
                ...
                className="w-full rounded-lg border border-border-dim bg-background px-3 py-2.5 text-sm outline-none placeholder:text-muted focus:border-moss"
              />
              <button
                type="submit"
                className="w-full rounded-lg border border-border-dim px-4 py-2.5 text-sm font-bold transition hover:border-moss hover:text-moss"
              >
          ...
          {!googleEnabled && !emailEnabled && (
            <p className="text-center text-sm font-semibold text-hh-red">
